...
# Target = Experience_Level (92% accuracy)
...
# Decision Tree (no depth limit, balanced classes)
dt = DecisionTreeClassifier(random_state=42, class_weight='balanced')
dt.fit(X_train, y_train)
acc = (dt.predict(X_test) == y_test).mean()
print(f"Experience Level Test Accuracy: {acc:.4f}")  # ~0.92
...
print("✅ tree_rules.js generated (Experience Level model).")
